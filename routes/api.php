...
//movimientos ventas y cobros
    ...
    Route::prefix('aperturas_cierres')->group(function () {
        Route::get('read', [Aperturas_cierresController::class, 'read']); // Listar aperturas/cierres del usuario logueado
        Route::get('buscar_caja_abierta', [Aperturas_cierresController::class, 'buscarCajaAbierta']); // Verificar si el usuario tiene una caja abierta
        Route::post('abrir', [Aperturas_cierresController::class, 'storeApertura']); // Apertura de caja
        Route::post('cerrar', [Aperturas_cierresController::class, 'cerrarCaja']); // Cierre de caja
    });
...
//informes referenciales ventas y cobros

//informes referenciales varios

//informes seguridad

//movimientos informes compras
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post("informes/compras/notas_compras", [Informes_comprasController::class, "notasCompras"]);
    Route::get("informes/compras/hoja_nota_compra/{id}", [Informes_comprasController::class, "hojaNotaCompra"]);
});
